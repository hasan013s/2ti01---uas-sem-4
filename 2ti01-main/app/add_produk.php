    ...
    <div class="card card-primary mt-3 ml-3">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="Stok" class="form-control" id="exampleInputPassword1" placeholder="Nama merek produk">
            </div>
            <div class="form-group">
...
<?php 
    if (isset($_POST['submit'])) {
        ...
        $app->addProduk($id_produk,$merek,$id_supplier,$id_satuan,$id_kategori,$deskripsi,$Stok);
        // ridirect link
