...
$id= $_GET['idproduk'];
$queryById = "SELECT * FROM produk WHERE id_produk='$id'";
    ...
    <div class="card card-primary mt-3 ml-3">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name="id_produk" class="form-control" id="exampleInputEmail1" value="<?php echo $item['id_produk']?>">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Merek Produk</label>
                <input type="text" name="merek" class="form-control" id="exampleInputPassword1" value="<?php echo $item["nm_produk"]?>" placeholder="Nama merek produk">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" id="exampleInputPassword1" cols="30" rows="10"><?php echo $item['deskripsi']?></textarea>
            </div>
...
<?php 
    if (isset($_POST['submit'])) {
        ...
        $app->updateProduk($id_produk,$merek,$id_supplier,$id_satuan,$id_kategori,$deskripsi,$stok,$id);
        // ridirect link
